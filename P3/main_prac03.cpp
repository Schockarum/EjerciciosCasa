...
void display(void)
{
	...
	glm::vec3 color = glm::vec3(1.0f);		//Agregamos esta instruccion para que inicialice un vector de colores en 1.0
	...
	//Aquí agregamos la instruccion para que el sader tome los colores del parámetro que le establecemos
	...
	//Como nueva manera de colorear cubos, agregamos la siguiente linea antes de cada cubo para cambiarle su color en RGB como queramos en formato de vectores. i.e.,
	projectionShader.setVec3("color", glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
